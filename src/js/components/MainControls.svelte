...
<div
  id="mainControls"
  class={`main-controls fixed bottom-4 left-4 top-4 py-2 px-4 border-1 border-black bg-ink bg-opacity-90 rounded-lg z-50 overflow-y-auto w-80 ${controlsClass}`}
>
